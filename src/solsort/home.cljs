...
(add-entry 
  ...
  ["2014" "production" "visualisering af relationer" "visualisation" "JavaScript"]
...
(add-entry 
  "Sketch note draw"
  ["2014" "experiment" "webapp" "infinite canvas" "zoomable"]
  "/sketch-note-draw/")
(add-entry 
  "Frie Børnesange"
...
(add-entry 
  "Single touch snake"
  ["2014" "experiment" "game" "webapp"]
  "/single-touch-snake/")
(add-entry 
  "Parkering i København"
  ["2014" "hackathon" "open data day" "data.kk.dk" "gatesense" "iotpeople" "okfn"]
  "/kbh-parking/")
(add-entry 
  "360º Viewer"
  ["2014" "widget" "frontend" "hammertime"]
  "/360/test.html")
(add-entry 
  "Backend for UCC-organismen"
  ["2014" "backend" "UCC Organismen" "ucc" "webuntis" "rejseplanen"]
  "http://ssl.solsort.com:8080/")
(add-entry 
  "BibTekKonf Slides"
  ["2013" "presentation" "dbc" "bibgraph"]
...
(add-entry 
  "BibGraph"
  ["2013" "visualisation" "widget" "dbc" "adhl" "d3"]
  "http://labs.dbc.dk/bibgraph")
(add-entry 
  "HTML5 Developer Perspective Slides"
  ["2013" "presentation" "html5" "cnug"]
  "/slides/talk-html5-2013/cnug2013-slides.html")
(add-entry 
  "Speeding visualisation"
  ["2013" "visualisation" "hammertime" "role:optimisation" "role:reimplementation"]
  "http://speeding.solsort.com/")
(add-entry 
  "Dragimation"
  ["2013" "widget" "hammertime" "legoland billund resort"]
  "http://dragimation.solsort.com")
(add-entry 
  "Pricing scale"
  ["2013" "notes" "estimation tool"]
  "/notes/pricing-scale")
(add-entry 
  "Tsar Tnoc"
  ["2012" "ludum dare" "hackathon"]
  "/tsartnoc/")
(add-entry 
  "EuroCards"
  ["2012" "card game"]
...
(add-entry 
  "BlobShot"
  ["2012" "game" "hackathon" "5apps hackathon"]
  "/blobshot/")
(add-entry 
  "CombiGame"
  ["2012" "game" "hackathon"]
