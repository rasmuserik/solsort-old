Various public notes and writings, all in this single README.md.
...
- released new version of visualisering-af-relationer
  - using info-webservice to show titles, which improves perceived performance immensely
  - more example code
  - also working when $ is called jQuery, making it easier to embed in ting-sites
- released/derived data from hack4dk-adhl-data into vejlebib/visual_relation_server
- released/created code for aggregating ADHL-data in solsort, - and a simple info-webservice

## 2015-01-05 week 1

- released/created code recommendation webservice in solsort

# Unpublished notes
## Solsort Product
TODO: this document needs refactoring

- Typical product
  - App, or advanced website-functionality (frontend+backend)
  - Deadline within weeks or months
  - Budget typically € 4.000-40.000 (DKK 30.000-300.000) or software as a service
