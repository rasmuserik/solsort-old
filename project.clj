  ...
  :cljsbuild { 
    :builds [
             {:id "debug"
              :source-paths ["src"]
              :compiler {
                :output-to "build/debug/debug.js"
                :output-dir "build/debug"
                :optimizations :none
                :pretty-print true
                :source-map "build/debug/debug.map"}}
             {:id "solsort"
              :source-paths ["src"]
              :compiler {
                :output-to "build/solsort/solsort.js"
                :output-dir "build/solsort/"
                ...
                :pretty-print true
                :source-map "build/solsort/solsort.map"}}]})
